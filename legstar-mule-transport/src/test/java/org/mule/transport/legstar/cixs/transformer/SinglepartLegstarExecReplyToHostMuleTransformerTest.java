 ...
 *
 */
public class SinglepartLegstarExecReplyToHostMuleTransformerTest extends AbstractTransformerTestCase {
     ...
     * Constructor.
     */
    public SinglepartLegstarExecReplyToHostMuleTransformerTest() {
        super();
