 ...
 *
 */
public class LsfileacXmlToHttpResponseTransformerTest extends AbstractTransformerTestCase {

    /** {@inheritDoc} */
    public AbstractMessageAwareTransformer getTransformer() throws Exception {
        AbstractMessageAwareTransformer transformer = new LsfileacXmlToHttpResponseTransformer();
