 ...
 *
 */
public class HostToSinglepartLegstarMuleTransformerTest extends AbstractTransformerTestCase {
     ...
     * Constructor.
     */
    public HostToSinglepartLegstarMuleTransformerTest() {
        super();
    ...
    public AbstractMessageAwareTransformer getTransformer() throws Exception {
        ...
        transformer.setProgramPropFileName("lsfileae.properties");
        return transformer;
    }
