...
/**
 * Test a roundtrip on the legstar WMQ transport with legstar messaging.
 *
 */
public class LegstarWmqLegstarFunctionalTestCase extends FunctionalTestCase {
    
    /**
     * Increase the timeout to allow enough time for debugging.
     */
    public LegstarWmqLegstarFunctionalTestCase() {
        super();
    ...
    protected String getConfigResources() {
        return "legstar-wmq-legstar-test-config-lsfileae.xml";
    }
