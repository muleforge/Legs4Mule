      ...
      * OVERVIEW                                                      *
      * --------                                                      *
      * Sample transaction calling a remote Mule UMO using LegStar    *
      * c2wsrt C API.                                                 *
      ...
      *
       77  C2WS-SERVICE-URI            PIC X(24) VALUE
           'http://192.168.0.7:8083/'.
      *
      * C2ws service credentials.
      *
       77  C2WS-USERID                 PIC X(5) VALUE
           'alice'.
       77  C2WS-PASSWORD               PIC X(12) VALUE
           'inwonderland'.
      *
      * Service requested.
      *
       77  C2WS-SERVICE-NAME           PIC X(8) VALUE
           'jvmquery'.
      ...
      *---------------------------------------------------------------*
       ...
       77  THIS-TRACE-ID               PIC X(13) VALUE 'LSC2QUER'.
      ...
      *---------------------------------------------------------------*
      *  Request parameters expected by target Mule UMO               *
      *---------------------------------------------------------------*
       01 COM-REQUEST.
           05 JvmQueryRequest.
               10 envVarNames--C PIC 9(9) BINARY.
               10 envVarNames PIC X(32) OCCURS 0
                   TO 10 DEPENDING ON envVarNames--C.
      ...
      *---------------------------------------------------------------*
      *  Reply parameters as returned by target Mule UMO              *
      *---------------------------------------------------------------*
       01 COM-REPLY.
           05 JvmQueryReply.
               ...
               10 envVarValues PIC X(32) OCCURS 0
                   TO 10 DEPENDING ON envVarValues--C.
      ...
      *---------------------------------------------------------------*
      *  Display results returned from target Mule UMO                *
      *---------------------------------------------------------------*
       PRINT-RESULTS.
